...
public class Log 
{
	...
	public static final String tagPrefix=(MeanUtil.getPackageName()==null?Log.class.getCanonicalName(): MeanUtil.getPackageName());
...
//						checkString(((Exception)str).getLocalizedMessage());
	...
	{
		return !MeanUtil.isReleaseSigned
